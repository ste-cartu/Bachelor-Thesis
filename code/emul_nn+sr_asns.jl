...
output = npzread("../files/train_out_asns_emul_" * string(nc) * ".npy")
...
valid_out = npzread("../files/val_out_asns_emul_" * string(ncv) * ".npy")
valid_out = valid_out'
...
function main(tstate::Lux.Experimental.TrainState, vjp, data, epochs, i)
    ...
    for epoch in 1:epochs
        ...
        if loss_validation < initial_loss_validation
            jldsave("../models/nn+sr_asns_$(cicli)-$(epoche)_$(div).jld2"; tstate)
